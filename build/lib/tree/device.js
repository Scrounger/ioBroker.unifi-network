...
((device2) => {
    ...
    return {
      ...
      disabled: {
        ...
        conditionToCreateState(objDevice, adapter) {
          return objDevice == null ? void 0 : objDevice.is_access_point;
        },
        read: false,
        write: true,
        role: "button",
      ...
      rx_bytes: {
        ...
        unit: "GB",
        readVal(val, adapter, cache, deviceOrClient, id) {
          return Math.round(val / 1e3 / 1e3 / 1e3 * 1e3) / 1e3;
        }
      },
      state: {
        iobType: "number",
      ...
      port_table: {
        ...
        arrayChannelIdFromProperty(objDevice, i, adapter) {
          return `port_${myHelper.zeroPad(objDevice == null ? void 0 : objDevice.port_idx, 2)}`;
        },
        ...
        array: {
          ...
          poe_enable: {
            ...
            name: "POE enabled",
            conditionToCreateState(objDevice, adapter) {
              return (objDevice == null ? void 0 : objDevice.port_poe) === true;
            },
          ...
          satisfaction: {
            ...
            name: "satisfaction",
            conditionToCreateState(objDevice, adapter) {
              return (objDevice == null ? void 0 : objDevice.satisfaction) >= 0 ? true : false;
            },
            unit: "%"
          },
          speed: {
      ...
      radio_table_stats: {
        ...
        arrayChannelNameFromProperty(objDevice, adapter) {
          return myHelper.radio_nameToFrequency(objDevice == null ? void 0 : objDevice.name, adapter);
        },
        array: {
          channel_utilization: {
            iobType: "number",
      ...
      storage: {
        ...
        arrayChannelNameFromProperty(objDevice, adapter) {
          return objDevice == null ? void 0 : objDevice.name;
        },
        array: {
          "mount_point": {
            iobType: "string",
      ...
      vap_table: {
        ...
        arrayChannelIdFromProperty(objDevice, i, adapter) {
          if (objDevice == null ? void 0 : objDevice.id) {
            return `${objDevice == null ? void 0 : objDevice.id}_${objDevice == null ? void 0 : objDevice.radio_name.replace("wifi", "").replace("ra0", "0").replace("rai0", "1")}`;
          } else {
            return void 0;
          }
        },
        arrayChannelNameFromProperty(objDevice, adapter) {
          return `${objDevice == null ? void 0 : objDevice.essid} - ${myHelper.radio_nameToFrequency(objDevice == null ? void 0 : objDevice.radio_name, adapter)}`;
        },
        array: {
          avg_client_signal: {
            iobType: "number",
  ...
  device2.getKeys = getKeys;
  function getStateIDs() {
    return myHelper.getAllIdsOfTreeDefinition(get());
  }
  device2.getStateIDs = getStateIDs;
  const _WAN_PROPERTIES = {
    current_download: {
      ...
      readVal(val, adapter, cache, deviceOrClient, id) {
        return Math.round(val / 1e3 / 1e3 * 1e3) / 1e3;
      }
    },
    current_upload: {
      iobType: "number",
