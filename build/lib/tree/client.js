...
((client2) => {
  let keys = void 0;
  client2.idChannel = "clients";
  client2.idChannelUsers = `${client2.idChannel}.users`;
  client2.idChannelGuests = `${client2.idChannel}.guests`;
  client2.idChannelVpn = `${client2.idChannel}.vpn`;
  function get() {
    return {
      ...
      imageUrl: {
        ...
        conditionToCreateState(objDevice, adapter) {
          return (objDevice == null ? void 0 : objDevice.type) === void 0 || (objDevice == null ? void 0 : objDevice.type) !== "VPN";
        },
        readVal(val, adapter, cache, deviceOrClient, id) {
      ...
      isOnline: {
        ...
        required: true,
        readVal(val, adapter, cache, deviceOrClient, id) {
          const diff = moment().diff(val * 1e3, "seconds");
      ...
      sw_port: {
        ...
        conditionToCreateState(objDevice, adapter) {
          return (objDevice == null ? void 0 : objDevice.is_wired) && (objDevice == null ? void 0 : objDevice.type) === void 0 || (objDevice == null ? void 0 : objDevice.type) === "WIRED";
        }
      },
      mac: {
        iobType: "string",
      ...
      reconnect: {
        ...
        conditionToCreateState(objDevice, adapter) {
          return !(objDevice == null ? void 0 : objDevice.is_wired) && (objDevice == null ? void 0 : objDevice.type) === void 0 || (objDevice == null ? void 0 : objDevice.type) === "WIRELESS";
        },
        read: false,
        write: true,
        role: "button"
      ...
      remote_ip: {
        ...
        name: "remote ip",
        conditionToCreateState(objDevice, adapter) {
          return (objDevice == null ? void 0 : objDevice.type) === "VPN";
        }
      },
      // remove: {
      //     id: 'remove',
  ...
  client2.getKeys = getKeys;
  function getStateIDs() {
    return myHelper.getAllIdsOfTreeDefinition(get());
  }
  client2.getStateIDs = getStateIDs;
})(client || (client = {}));
export {
  client
};
