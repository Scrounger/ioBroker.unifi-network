...
import type { NetworkDevice, NetworkDeviceStorage, NetworkDevicePortTable, NetworkDeviceRadioTableStat, NetworkDeviceTemperature, NetworkDeviceVapTable, NetworkDeviceRadioTable, NetworkDeviceWan, NetworkDeviceWanUptimeStats, NetworkDeviceSystemStats, NetworkDeviceWanStats } from '../api/network-types-device.js';
...
export namespace device {
    ...
    const _WAN_PROPERTIES: { [key: string]: myTreeDefinition<any, NetworkDevice, ioBroker.myAdapter> } = {
        current_download: {
            iobType: 'number',
        ...
        speedtest_run: {
            ...
            async writeVal(val: boolean, id: string, device: NetworkDevice, adapter: ioBroker.myAdapter): Promise<void> {
                ...
                try {
                    ...
                    if (wan_interface && adapter.myIob?.hasKey(device, wan_interface)) {
                        const interface_name = (device[wan_interface] as NetworkDeviceWanStats).ifname;
    ...
    const _ISP_UPTIME_PROPERTIES: { [key: string]: myTreeDefinition<any, NetworkDevice, ioBroker.myAdapter> } = {
        availability: {
            iobType: 'number',
            name: 'availability',
            unit: '%',
        ...
        downtime: {
            ...
            unit: 's',
            def: 0,
            async readVal(val: number, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDevice, id: string): Promise<ioBroker.StateValue> {
                // if downtime increase, isp connection is down
                const isOnlineId = `${adapter.myIob?.getIdWithoutLastPart(id)}.isOnline`;
    ...
    const _ISP_GEO_INFO_PROPERTIES: { [key: string]: myTreeDefinition<any, NetworkDevice, ioBroker.myAdapter> } = {
        address: {
            id: 'ip',
            iobType: 'string',
    ...
    export function get(): { [key: string]: myTreeDefinition<any, any, ioBroker.myAdapter> } {
        return {
            connected_clients: {
            ...
            port_table: {
                ...
                array: {
                    ...
                    poe_enable: {
                        ...
                        read: true,
                        write: true,
                        readVal(val: string, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDevicePortTable, id: string): ioBroker.StateValue {
                            return val === 'auto';
                        },
                        async writeVal(val: boolean, id: string, device: NetworkDevice, adapter: ioBroker.myAdapter): Promise<void> {
            ...
            radio_table: {
                ...
                array: {
                    ...
                    channel_name: {
                        ...
                        readVal(val: string, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDeviceRadioTable, id: string): ioBroker.StateValue {
                    ...
                    tx_power_mode: {
                        ...
                        async writeVal(val: string, id: string, device: NetworkDevice, adapter: ioBroker.myAdapter): Promise<void> {
                            ...
                            if (adapter.myIob) {
                                const channelNr = parseInt(adapter.myIob.getIdLastPart(adapter.myIob.getIdWithoutLastPart(id)));
            ...
            storage: {
                ...
                array: {
                    ...
                    size: {
                        ...
                        name: 'size',
                        unit: 'GB',
                        readVal(val: number, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDeviceStorage, id: string): ioBroker.StateValue {
                            return Math.round(val / 1000 / 1000 / 1000 * 1000) / 1000;
                        }
                    },
                    type: {
            ...
            "system-stats": {
                ...
                object: {
                    cpu: {
                        iobType: 'number',
                        unit: '%',
                        readVal(val: string, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDeviceSystemStats, id: string): ioBroker.StateValue {
                            return parseFloat(val);
                        },
            ...
            temperatures: {
                ...
                array: {
                    ...
                    value: {
                        ...
                        name: 'value',
                        unit: '°C',
                        readVal: function (val: number, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDeviceTemperature, id: string): ioBroker.StateValue {
            ...
            temperature: {
                ...
                readVal: function (val: number, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDevice, id: string): ioBroker.StateValue {
                    return Math.round(val * 10) / 10;
                },
            },
            tx_bytes: {
            ...
            vap_table: {
                ...
                array: {
                    ...
                    channel_name: {
                        ...
                        readVal(val: string, adapter: ioBroker.myAdapter, device: NetworkDevice, channel: NetworkDeviceVapTable, id: string): ioBroker.StateValue {
                            return myHelper.radio_nameToFrequency(val, adapter);
                        }
                    },
                    connected_clients: {
